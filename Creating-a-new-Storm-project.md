...
You'll need the Storm jars on your classpath to develop Storm topologies. Using [[Maven]] is highly recommended. If you don't want to use Maven, you can include the jars from the Storm release on your classpath. 
